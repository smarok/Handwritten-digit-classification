Handwritten digit classification GUI which can recognize handwritten digits with help of Deep Learning (Convolutional Neural Network).
This project consists of 3 files: GUI.py, Model.py and digit_classification.h5

(you just need to run GUI.py in order to launch the project)
